...
def wec_dyn(bodies,A,B,C,F,m,omega,Amp,reactive,F_max=np.inf,check_condition=True,q_single=False):    # Calculates WEC motion based on hydro outputs
    ...
    if q_single: 
        for body in bodies: body.PTOdamp = (B[body][body]**2+(omega*(m[body][0][0]+A[body][body])-C[body][0][0]/omega)**2)**0.5 
